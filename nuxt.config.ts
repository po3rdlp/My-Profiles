...
export default defineNuxtConfig({
  runtimeConfig: {
    public: {
      ...
      FIREBASE_PUBLIC_AUTH_DOMAIN:
        process.env.VERCEL_ENV_NUXT_PUBLIC_AUTH_DOMAIN,
      FIREBASE_PROJECT_ID: process.env.VERCEL_ENV_NUXT_PUBLIC_PROJECT_ID,
      FIREBASE_STORAGE_BUCKET:
        process.env.VERCEL_ENV_NUXT_PUBLIC_STORAGE_BUCKET,
      FIREBASE_MESSAGING_SENDER_ID:
        process.env.VERCEL_ENV_NUXT_PUBLIC_MESSAGING_SENDER_ID,
      FIREBASE_APP_ID: process.env.VERCEL_ENV_NUXT_PUBLIC_APP_ID,
      FIREBASE_MEASUREMENT_ID:
        process.env.VERCEL_ENV_NUXT_PUBLIC_MEASUREMENT_ID,
  ...
  modules: ["nuxt-icon", "@pinia/nuxt", "nuxt-marquee", "nuxt-particles", "@nuxtjs/google-fonts"],
  pinia: {
